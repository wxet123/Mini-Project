...
<body>
  ...
  <nav class="mb-1 navbar navbar-expand-lg navbar-dark">
   <a href="dashboard.jsp"> <img src="images/ELearningIcon.png" width="40px"> </a>
    <a class="navbar-brand" href="dashboard.jsp">E - Learning</a>
      ...
      <div class="row">
        <div class="col-6">
          <div class="card px-md-5 py-md-2 mb-3">
            ...
            <div class="text-center mt-3">
              <button type="button" class="btn" id="addTraining" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Training</button>
        ...
        <div class="col-6">
          <div class="card px-md-5 py-md-2 mb-3">
            ...
            <div class="text-center mt-3">
              <a href="ListOfTrainings.jsp"><button type="button"  class="btn">LIST OF TRAINING</button></a>
            </div>
